...
function renderMovies(response) {
    ...
    for (var i in response.Search) {
      ...
      li.append('<button  data-imdb='+ movie.imdbID +' data-poster='+ movie.Poster +' data-year='+ movie.Year +'  data-Title='+ movie.Title +'  type="button" class="btn btn-fav">favoritos</button>');
      movieList.append(li);
